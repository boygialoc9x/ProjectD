...
//__TYPE_DEF__ ## _provided: using __TYPE_DEF__ = __NAME__;
 ...
 * @prama _VAR_ Your variable type.
 * @prama _FIRST_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
#define QUICK_VAR(_VAR_, _FIRST_, ...) _VAR_ _FIRST_, ## __VA_ARGS__;

/**
 * @def List all your int variable here.
 * @prama _INT_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
#define QUICK_INT(_INT_, ...) QUICK_VAR(int, _INT_, ##__VA_ARGS__)

/**
 * @def List all your float variable here.
 * @prama _FLOAT_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
#define QUICK_FLOAT(_FLOAT_, ...) QUICK_VAR(float, _FLOAT_, ##__VA_ARGS__)

/**
 * @def List all your double variable here.
 * @prama _DOUBLE_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
#define QUICK_DOUBLE(_DOUBLE_, ...) QUICK_VAR(double, _DOUBLE_, ##__VA_ARGS__)

/**
 * @def List all your std::string variable here.
 * @prama _STR_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
#define QUICK_STR(_STR_, ...) QUICK_VAR(std::string, _STR_, ##__VA_ARGS__)

/**
 * @def List all your const char variable here.
 * @prama _CHP_ Your first variable name.
 * @prama ... All your next variable name.
 * @note You can put the '*' in your prefix variable to make it a pointer
 */
